...
public class DialogMenuActivity extends BaseActivity {
    TextView label = null;
    ...
    private void showDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(DialogMenuActivity.this);
        ...
        dialog.setNegativeButton("NG", null);
        dialog.show();
    }

    // テキストダイアログの表示
    public void showTextDialog() {
        final EditText editText = new EditText(DialogMenuActivity.this);
        AlertDialog.Builder dialog = new AlertDialog.Builder(DialogMenuActivity.this);
    ...
    public void showDatePickerDialog() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(DialogMenuActivity.this
    ...
    public void showTimePickerDialog() {
        TimePickerDialog dialog = new TimePickerDialog(DialogMenuActivity.this
    ...
    public void showProgressDialog() {
        dialog = new ProgressDialog(DialogMenuActivity.this);
